...
def merge_rules():
    options = {
        ...
        'NSFW.list': [
            ...
            'https://raw.githubusercontent.com/sounfury/sounfury-Clash_rules/main/rule/sexy.list',
        ],
        'Developer.list': [
        ...
        'AI.list': [
            ...
            'https://raw.githubusercontent.com/VPSDance/ai-proxy-rules/refs/heads/main/rules/surge/all.list'
        ],
        'Anti-Ads.list': [],
        'DNS.list': [],
        'Download.list': [],
